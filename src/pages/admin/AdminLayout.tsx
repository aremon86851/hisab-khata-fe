      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="md:hidden bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800 px-4 flex-shrink-0">
          <div className="flex items-center justify-between py-3">
            ...
            <button
              onClick={logout}
              className="text-slate-500 dark:text-slate-400 text-xs px-3 py-1.5 rounded-lg border border-gray-300 dark:border-slate-700"
            >
              লগআউট
            </button>
          </div>
        ...
        <div className="hidden md:flex items-center px-6 py-4 border-b border-gray-100 dark:border-slate-800 flex-shrink-0">
          <div>
            ...
            <div className="text-slate-500 dark:text-slate-400 text-xs">
              HisabKhata Admin — Platform Control
            </div>
          </div>
        </div>
          ...
          <div className="flex">
            {NAV.map((n) => (
              ...
              >
                ...
                <span className="text-[9px] mt-0.5 font-semibold truncate max-w-[48px]">
                  {n.label}
                </span>
                {pathname.startsWith(n.path) && (
