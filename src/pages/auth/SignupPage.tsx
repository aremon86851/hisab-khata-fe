...
export default function SignupPage() {
  ...
  const handleRegister = () => {
    setError("");
    role === "shopkeeper" ? skMut.mutate() : cuMut.mutate();
  };
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-5">
                {[
                  ...
                  { r: "customer" as const, icon: "👤", label: "Customer" },
                ].map(({ r, icon, label }) => (
                  <button
                    key={r}
                    onClick={() => setRole(r)}
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  loading={skMut.isPending || cuMut.isPending}
                  className="flex-1"
                >
                  OTP পান →
                </Button>
          ...
          {step === "pin" && (
            <div className="space-y-5">
              ...
              <Button
                ...
                disabled={pin.length < 4 || pinConfirm.trim() !== pin}
                className="w-full"
              >
